...
const navLinks = [
  ...
  { label: 'Invite Customer', path: '/customers/invite' },
]
  ...
  <aside class="wms-sidebar">
    <div class="wms-sidebar__top">
      <div class="wms-sidebar__brand">
        ...
        <span class="wms-sidebar__title">Admin</span>
      </div>
    </div>

    <nav class="wms-sidebar__nav">
      <button
    ...
    <div class="wms-sidebar__bottom">
      ...
      <div class="wms-sidebar__actions">
        <WmsThemeToggle />
        <button class="wms-sidebar__logout" @click="emit('logout')">
          Logout
        </button>
      </div>
    </div>
